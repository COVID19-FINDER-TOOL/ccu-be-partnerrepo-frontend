...
const CustomButton =  (props)=>{
  ...
  style={{width:props.width,borderStyle:'none',backgroundColor:props.disabled||props.data.disabled?'#b5b3b3':'',margin:props.margin, float:props.float}} tabIndex={props.data.tabindex}  
